Tags:[[Networks]][[Network Structure]][[Subnet]]
...
The WAN (Wide Area Network) is commonly referred to as `The Internet`,  WAN is just a large number of LANs joined together
